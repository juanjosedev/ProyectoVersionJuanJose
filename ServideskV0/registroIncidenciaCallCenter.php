...
<?php 
    ...
    require_once("Sesiones/verificar.php");
...
$consulta3="INSERT INTO incidenciastbl (`ID_INCIDENTE`,`DOC_USUARIO`, `FECHA_INCIDENTE`,`DES_INCIDENCIA`,`TIPO_INCIDENCIA`,`ESTADO_INCIDENCIA`,`PRONOSTICO_PRE`,`RESOLUCION`,`TEC_ASIGNADO`, `ID_TECNICO`)VALUES 
          (NULL, '$DOC_USUARIO', '$FECHA_INCIDENCIA',' $DES_INCIDENCIA','$TIPO_INCIDENCIA','$ESTADO_INCIDENCIA','$PRONOSTICO_PRE','$RESOLUCION','$TEC_ASIGNADO', '$ID_TECNICO')";
